<?php  require "head.php";  ?>
  ...
  <!-- Start Hero -->
  <div class="cs-page_heading cs-style1 cs-center text-center cs-bg" data-src="assets/img/service_hero_bg.jpg">
    <div class="container">
        ...
        <div class="col-xl-8">
          ...
          <div class="col-lg-3 col-sm-6 cs-hidden_mobile"></div>
            <div class="col-lg-3 col-sm-6">
              <div class="cs-hobble">
                <a href="contact.php" class="cs-card cs-style1 cs-hover_layer1">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="cs-hobble">
                <a href="contact.php" class="cs-card cs-style1 cs-hover_layer1">
                  ...
                  <div class="cs-card_info">
                    <span class=" cs-hover_layer3 cs-accent_bg"></span>
                    <h2 class="cs-card_title">Wordpress Web Development</h2>
                  </div>
                </a>
              </div>
              <div class="cs-height_0 cs-height_lg_30"></div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="cs-hobble">
                <a href="contact.php" class="cs-card cs-style1 cs-hover_layer1">
                  <img src="assets/img/custom.jpg" alt="Service">
                  <div class="cs-card_overlay"></div>
                  <div class="cs-card_info">
                    <span class=" cs-hover_layer3 cs-accent_bg"></span>
                    <h2 class="cs-card_title">Custom Website Designing</h2>
                  </div>
                </a>
              </div>
              <div class="cs-height_0 cs-height_lg_30"></div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="cs-hobble">
                <a href="contact.php" class="cs-card cs-style1 cs-hover_layer1">
                  <img src="assets/img/shopify.jpg" alt="Service">
                  <div class="cs-card_overlay"></div>
                  <div class="cs-card_info">
                    <span class=" cs-hover_layer3 cs-accent_bg"></span>
                    <h2 class="cs-card_title">Shopify Development</h2>
                  </div>
                </a>
              </div>
              <div class="cs-height_0 cs-height_lg_30"></div>
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="cs-pricing_table cs-style1">
                  ...
                  <div class="cs-pricing_info">
                    <div class="cs-price">
                      <h3 class="cs-white_color">$1000/</h3>
                  ...
                  <ul class="cs-pricing_feature cs-mp0">
                    ...
                    <li>                      <span class="cs-feature_icon cs-accent_color">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M2 10C2 5.59 5.59 2 10 2C14.41 2 18 5.59 18 10C18 14.41 14.41 18 10 18C5.59 18 2 14.41 2 10ZM0 10C0 15.52 4.48 20 10 20C15.52 20 20 15.52 20 10C20 4.48 15.52 0 10 0C4.48 0 0 4.48 0 10ZM10 9H6L6 11H10V14L14 10L10 6L10 9Z" fill="currentColor"/>
                        </svg>
                      </span>
              ...
              <div class="col-lg-4">
                <div class="cs-pricing_table cs-style1">
                  ...
                  <div class="cs-pricing_info">
                    <div class="cs-price">
                      <h3 class="cs-white_color">$2999/</h3>
                      <span class="cs-accent_color">Yearly</span>
                    </div>
                    <div class="cs-price_text">Per subscriber per year</div>
                  </div>
              ...
              <div class="col-lg-4">
                <div class="cs-pricing_table cs-style1">
                  ...
                  <div class="cs-pricing_info">
                    <div class="cs-price">
                      <h3 class="cs-white_color">$5999/</h3>
                      <span class="cs-accent_color">Yearly</span>
                    </div>
                    <div class="cs-price_text">Per subscriber per year</div>
                  </div>

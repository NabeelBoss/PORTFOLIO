<?php  require "head.php";  ?>
    ...
    <!-- Start Hero -->
    <div class="cs-page_heading cs-style1 cs-center text-center cs-bg" data-src="assets/img/about_hero_bg.jpg">
      <div class="container">
          ...
          <div class="col-xl-5 col-lg-6">
            <div class="cs-image_layer cs-style1">
              <div class="cs-image_layer_in">
                <img src="assets/img/about_img_1.jpg" alt="Image" class="w-100 cs-radius_15">
              </div>
            </div>
              ...
              <div class="cs-slide">
                <div class="cs-team cs-style1">
                  <div class="cs-member_thumb">
                    <img src="assets/img/member_1.png" alt="Member" />
                  ...
                  <div class="cs-member_info">
                    ...
                    <div class="cs-member_designation">Communication Manager</div>
                  </div>
              ...
              <!-- <div class="cs-slide">
                <div class="cs-team cs-style1">
                  ...
                  <div class="cs-member_info">
                    ...
                    <div class="cs-member_designation">Web and Mobile Lead</div>
                  </div>
                  <div class="cs-member_social cs-primary_color">
                    <a href="#">
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- <div class="cs-slide">
                <div class="cs-team cs-style1">
                  ...
                  <div class="cs-member_info">
                    ...
                    <div class="cs-member_designation">Game Development Lead</div>
                  </div>
                  <div class="cs-member_social cs-primary_color">
                    <a href="#">
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">

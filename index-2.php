  ...
  <div class="cs-hero cs-style1 cs-bg cs-fixed_bg cs-shape_wrap_1" data-src="assets/img/hero_bg.jpeg" id="home">
    ...
    <div class="container">
      <div class="cs-hero_text">
        <h1 class="cs-hero_title wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s"> Creativity In
          <br />Our Blood Line </h1>
        ...
        <div class="col-xl-8">
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="cs-hobble">
                <a href="service.php" class="cs-card cs-style1 cs-hover_layer1">
                  <img src="assets/img/service_1.jpg" alt="Service" />
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="cs-hobble">
                <a href="service.php" class="cs-card cs-style1 cs-hover_layer1">
                  <img src="assets/img/service_2.jpg" alt="Service" />
                  <div class="cs-card_overlay"></div>
                  <div class="cs-card_info">
                    <span class="cs-hover_layer3 cs-accent_bg"></span>
                    <h2 class="cs-card_title">Video Editing</h2>
                  </div>
                </a>
              </div>
              <div class="cs-height_0 cs-height_lg_30"></div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="cs-hobble">
                <a href="service.php" class="cs-card cs-style1 cs-hover_layer1">
                  <img src="assets/img/service_3.jpg" alt="Service" />
                  <div class="cs-card_overlay"></div>
                  <div class="cs-card_info">
                    <span class="cs-hover_layer3 cs-accent_bg"></span>
                    <h2 class="cs-card_title">Ecommerce Store</h2>
                  </div>
                </a>
              </div>
              <div class="cs-height_0 cs-height_lg_30"></div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="cs-hobble">
                <a href="service.php" class="cs-card cs-style1 cs-hover_layer1">
                  <img src="assets/img/service_4.jpg" alt="Service" />
                  <div class="cs-card_overlay"></div>
                  <div class="cs-card_info">
                    <span class="cs-hover_layer3 cs-accent_bg"></span>
          ...
          <div class="slider-for cs-style1">
            <div class="slider-for_item">
              <div class="cs-testimonial cs-style1">
                ...
                <div class="cs-testimonial_text">I had the pleasure of working with Zyvor for my web development
                  project, and the experience was nothing short of exceptional. The team, led by some talented males,
                  demonstrated expertise and professionalism throughout. They brought my vision to life with precision
                  and creativity. Kudos to the guys at Zyvor for a job well done!</div>
            ...
            <div class="slider-for_item">
              <div class="cs-testimonial cs-style1">
                ...
                <div class="cs-testimonial_text"> Zyvor male developers really know their stuff! I approached them for
                  app development, and they delivered a top-notch product within the agreed-upon timeframe. What
                  impressed me the most was their attention to detail and ability to adapt to changes seamlessly. These
                  guys are reliable and skilled—definitely recommend.</div>
                <div class="cs-rating" data-rating="4">
                  <div class="cs-rating_bg" data-src="assets/img/rating.html"></div>
                  <div class="cs-rating_percentage" data-src="assets/img/rating.html"></div>
                </div>
            ...
            <div class="slider-for_item">
              <div class="cs-testimonial cs-style1">
                ...
                <div class="cs-testimonial_text"> Zyvor 24/7 availability sets them apart. Their prompt responses and
                  proactive communication made our collaboration smooth and efficient. The team's dedication to our
                  success is evident, making them a reliable partner.</div>
                <div class="cs-rating" data-rating="4">
                  <div class="cs-rating_bg" data-src="assets/img/rating.html"></div>
                  <div class="cs-rating_percentage" data-src="assets/img/rating.html"></div>
                </div>
            ...
            <div class="slider-for_item">
              <div class="cs-testimonial cs-style1">
                ...
                <div class="cs-testimonial_text">Zyvor comprehensive business plan was a game-changer for our company.
                  It provided clarity and direction for our future endeavors. The team's expertise and commitment to
                  client satisfaction make them our go-to agency for all things business-related. </div>
                <div class="cs-rating" data-rating="4">
                  <div class="cs-rating_bg" data-src="assets/img/rating.html"></div>
                  <div class="cs-rating_percentage" data-src="assets/img/rating.html"></div>
                </div>
            ...
            <div class="slider-for_item">
              <div class="cs-testimonial cs-style1">
                ...
                <div class="cs-testimonial_text">Zyvor exceeded our expectations on all fronts. The development team's
                  creativity, coupled with their strategic social media insights, turned our project into a success
                  story. Their commitment to quality and results is matched. </div>
                <div class="cs-rating" data-rating="4">
                  <div class="cs-rating_bg" data-src="assets/img/rating.html"></div>
                  <div class="cs-rating_percentage" data-src="assets/img/rating.html"></div>
                </div>
            ...
            <div class="slider-for_item">
              <div class="cs-testimonial cs-style1">
                ...
                <div class="cs-testimonial_text">Choosing Zyvor was a game-changer for our startup. From the initial
                  consultation to the final delivery, their team demonstrated professionalism and expertise. Their
                  dedication to understanding our brand resulted in a website that truly reflects our identity.</div>
                <div class="cs-rating" data-rating="4">
                  <div class="cs-rating_bg" data-src="assets/img/rating.html"></div>
                  <div class="cs-rating_percentage" data-src="assets/img/rating.html"></div>
                </div>

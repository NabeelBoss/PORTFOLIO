<?php  require "head.php";  ?>
  ...
  <div class="cs-hero cs-style1 cs-bg cs-fixed_bg cs-shape_wrap_1" data-src="assets/img/hero_bg.jpeg" id="home">
    ...
    <div class="container">
      <div class="cs-hero_text">
        <h1 class="cs-hero_title wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s"> Creativity Is
          <br />My Blood Line </h1>
        <div class="cs-hero_info">
          ...
          <div>
            <div class="cs-hero_subtitle"> We deliver best problem solving solution for our client and provide finest
    ...
    <div class="cs-hero_social_wrap cs-primary_font cs-primary_color">
      <div class="cs-hero_social_title"><a href="https://www.instagram.com/nabeel._.2639/">Follow Me</a></div>
      <ul class="cs-hero_social_links">
        <li>
          
        </li>
        <li>
          <a href="https://www.instagram.com/nabeel._.2639/">Instagram</a>
        </li>
      </ul>
    </div>
  ...
  <section>
    <div class="container">
      <div class="cs-funfact_wrap cs-type1">
        <div class="cs-funfact_shape" data-src="assets/img/funfact_shape_bg.html"></div>
        <div class="cs-funfact_left">
          <div class="cs-funfact_heading">
            <h2>Our Fun Fact</h2>
            <p> An Agency That Builds Identity And Design
              For You, The Brand Of Your Dreams</p>
          </div>
        </div>
          ...
          <div class="cs-funfacts">
            <div class="cs-funfact cs-style1">
              <div class="cs-funfact_number cs-primary_font cs-semi_bold cs-primary_color">
                <span data-count-to="8" class="odometer"></span>
              </div>
            ...
            <div class="cs-funfact cs-style1">
              <div class="cs-funfact_number cs-primary_font cs-semi_bold cs-primary_color">
                <span data-count-to="800" class="odometer"></span>$+
              </div>
              <div class="cs-funfact_text">
                <span class="cs-accent_color"></span>
                <p>Earned</p>
        ...
        <div class="col-xl-8">
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="cs-hobble">
                <a href="service.php" class="cs-card cs-style1 cs-hover_layer1">
                  <img src="assets/img/scratch.jpg" alt="Service" />
                  <div class="cs-card_overlay"></div>
                  <div class="cs-card_info">
                    <span class="cs-hover_layer3 cs-accent_bg"></span>
                    <h2 class="cs-card_title">Website Development</h2>
                  </div>
                </a>
              </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="cs-hobble">
                <a href="service.php" class="cs-card cs-style1 cs-hover_layer1">
                  <img src="assets/img/graphicdesigner.jpg" alt="Service" />
                  <div class="cs-card_overlay"></div>
                  <div class="cs-card_info">
                    <span class="cs-hover_layer3 cs-accent_bg"></span>
                    <h2 class="cs-card_title">Graphic Desinging</h2>
                  </div>
                </a>
              </div>
              <div class="cs-height_0 cs-height_lg_30"></div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="cs-hobble">
                <a href="service.php" class="cs-card cs-style1 cs-hover_layer1">
                  <img src="assets/img/wordpress.jpg" alt="Service" />
                  <div class="cs-card_overlay"></div>
                  <div class="cs-card_info">
                    <span class="cs-hover_layer3 cs-accent_bg"></span>
                    <h2 class="cs-card_title">Wordpress Development</h2>
                  </div>
                </a>
              </div>
              <div class="cs-height_0 cs-height_lg_30"></div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="cs-hobble">
                <a href="service.php" class="cs-card cs-style1 cs-hover_layer1">
                  <img src="assets/img/seoo.png" alt="Service" />
                  <div class="cs-card_overlay"></div>
                  <div class="cs-card_info">
                    <span class="cs-hover_layer3 cs-accent_bg"></span>
  ...
  <div class="container">
    <h2 class="cs-font_50 cs-m0 text-center cs-line_height_4 wow fadeInUp" data-wow-duration="0.8s"
      data-wow-delay="0.2s"> Explore our recent project.</h2>
  </div>
    ...
    <div class="cs-slider cs-style2 cs-gap-12">
      <div class="cs-slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
        ...
        <div class="cs-slider_wrapper">
          <div class="cs-slide">
            <a href="#" class="cs-portfolio cs-style1 cs-type2 cs-size3">
              <div class="cs-portfolio_hover"></div>
              <div class="cs-portfolio_bg cs-bg" data-src="assets/img/rec_pro_3_11zon.png"></div>
              <div class="cs-portfolio_info">
                <div class="cs-portfolio_info_bg cs-accent_bg"></div>
                <h2 class="cs-portfolio_title">Business Websites</h2>
          ...
          <div class="cs-slide">
            <a href="#" class="cs-portfolio cs-style1 cs-type2 cs-size3">
              <div class="cs-portfolio_hover"></div>
              <div class="cs-portfolio_bg cs-bg" data-src="assets/img/rec_pro_7_11zon.png"></div>
              <div class="cs-portfolio_info">
                <div class="cs-portfolio_info_bg cs-accent_bg"></div>
                <h2 class="cs-portfolio_title">Ecommerce Site</h2>
                <div class="cs-portfolio_subtitle">See Details</div>
              </div>
            </a>
          </div>
          ...
          <div class="cs-slide">
            <a href="#" class="cs-portfolio cs-style1 cs-type2 cs-size3">
              <div class="cs-portfolio_hover"></div>
              <div class="cs-portfolio_bg cs-bg" data-src="assets/img/re_pro_4_11zon.png"></div>
              <div class="cs-portfolio_info">
                <div class="cs-portfolio_info_bg cs-accent_bg"></div>
                <h2 class="cs-portfolio_title">Blogging Sites</h2>
                <div class="cs-portfolio_subtitle">See Details</div>
              </div>
            </a>
          </div>
  ...
  <!-- <div class="cs-height_70 cs-height_lg_70"></div>
    <!-- Start Video Block -->
  <!-- <div class="container">
      <a href="https://www.youtube.com/watch?v=Ma6oz56REs8" class="cs-video_block cs-style1 cs-video_open cs-bg" data-src="assets/img/video_bg.jpeg">
  ...
  <div class="cs-team cs-style1">
    <div class="cs-member_thumb">
      <img src="assets/img/member_1.jpg" alt="Member" />
      <div class="cs-member_overlay"></div>
    </div>
    <div class="cs-member_info">
      <h2 class="cs-member_name">
        <a href="about.php">Saqib Ali</a>
      </h2>
      <div class="cs-member_designation " style="color: #f9f9f9;">Full stack web developer</div>
    </div>
            ...
            <div class="cs-slide">
              <div class="cs-team cs-style1">
                <div class="cs-member_thumb">
                  <img src="assets/img/member_4.png" alt="Member" />
                  <div class="cs-member_overlay"></div>
                </div>
                <div class="cs-member_info">
                  <h2 class="cs-member_name">
                    <a href="about.php">Ahmed Raza</a>
                  </h2>
                  <div class="cs-member_designation" style="color: #f9f9f9;">UI/UX</div>
                </div>
              </div>
            </div>
            <!-- .cs-slide -->
            <div class="cs-slide">
              <div class="cs-team cs-style1">
                <div class="cs-member_thumb">
                  <img src="assets/img/member_3.png" alt="Member" />
                  <div class="cs-member_overlay"></div>
                </div>
                <div class="cs-member_info">
                  <h2 class="cs-member_name">
                    <a href="about.php">Zakria sheraz</a>
                  </h2>
                  <div class="cs-member_designation " style="color: #f9f9f9;">Digital Marketer </div>
                </div>
            ...
            <div class="cs-slide">
              <div class="cs-team cs-style1">
                <div class="cs-member_thumb">
                  <img src="assets/img/member_2.png" alt="Member" />
                  <div class="cs-member_overlay"></div>
                </div>
                <div class="cs-member_info">
                  <h2 class="cs-member_name">
                    <a href="about.php">Roobeel Qureshi</a>
                  </h2>
                  <div class="cs-member_designation" style="color: #f9f9f9;">Video editor</div>
                </div>
            ...
            <div class="cs-slide">
              <div class="cs-team cs-style1">
                <div class="cs-member_thumb">
                  <img src="assets/img/member_10.html" alt="Member" />
                  <div class="cs-member_overlay"></div>
                </div>
                <div class="cs-member_info">
                  <h2 class="cs-member_name">
                    <a href="about.php">Faizan Manzoor</a>
                  </h2>
                  <div class="cs-member_designation" style="color: #f9f9f9;">Seo Expert</div>
                </div>
            ...
            <div class="slider-nav cs-style1">
                ...
                <div class="slider-nav_item">
                  <div class="cs-rotate_img">
                    <div class="cs-rotate_img_in">
                      <img src="assets/picutres_staff-1/picutres%20staff/Picture1%20(10).png" alt="Nav Image" />
                    </div>
                  </div>
                </div>
              </div>
              <div class="slider-for_item item-nav">
                <div class="slider-nav_item">
                  <div class="cs-rotate_img">
                    <div class="cs-rotate_img_in">
                      <img src="assets/picutres_staff-1/picutres%20staff/Picture1%20(11).png" alt="Nav Image" />
                    </div>
                  </div>
                </div>
              </div>
              <div class="slider-for_item item-nav">
                <div class="slider-nav_item">
                  <div class="cs-rotate_img">
                    <div class="cs-rotate_img_in">
                      <img src="assets/picutres_staff-1/picutres%20staff/Picture1%20(12).png" alt="Nav Image" />
                    </div>
                  </div>
                </div>
              </div>
              <div class="slider-for_item item-nav">
                <div class="slider-nav_item">
                  <div class="cs-rotate_img">
                    <div class="cs-rotate_img_in">
                      <img src="assets/picutres_staff-1/picutres%20staff/Picture1%20(7).html" alt="Nav Image" />
                    </div>
                  </div>
                </div>
              </div>
              <div class="slider-for_item item-nav">
                <div class="slider-nav_item">
                  <div class="cs-rotate_img">
                    <div class="cs-rotate_img_in">
                      <img src="assets/picutres_staff-1/picutres%20staff/Picture1%20(8).html" alt="Nav Image" />
                    </div>
                  </div>
                </div>
              </div>
              <div class="slider-for_item item-nav">
                <div class="slider-nav_item">
                  <div class="cs-rotate_img">
                    <div class="cs-rotate_img_in">
                      <img src="assets/picutres_staff-1/picutres%20staff/Picture1%20(9).html" alt="Nav Image" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="slider-for cs-style1">
              <div class="slider-for_item">
                <div class="cs-testimonial cs-style1">
                  ...
                  <div class="cs-testimonial_text">I had the pleasure of working with Nabeel for my web development project, and the experience was nothing short of exceptional. The team, led by some talented males, demonstrated expertise and professionalism throughout. They brought my vision to life with precision and creativity. Kudos to the Nabeel for a job well done!</div>
                  <div class="cs-rating" data-rating="4">
                    <div class="cs-rating_bg" data-src="assets/img/rating.html"></div>
                    <div class="cs-rating_percentage" data-src="assets/img/rating.html"></div>
                  </div>
                  <h2 class="cs-testimonial_avatar_name">Johnathan W.</h2>
                </div>
              </div>
              <div class="slider-for_item">
                <div class="cs-testimonial cs-style1">
                  ...
                  <div class="cs-testimonial_text"> Nabeel really know their stuff! I approached them for app development, and they delivered a top-notch product within the agreed-upon timeframe. What impressed me the most was their attention to detail and ability to adapt to changes seamlessly. These guys are reliable and skilled—definitely recommend.</div>
                  <div class="cs-rating" data-rating="4">
                    <div class="cs-rating_bg" data-src="assets/img/rating.html"></div>
                    <div class="cs-rating_percentage" data-src="assets/img/rating.html"></div>
                  </div>
                  <h2 class="cs-testimonial_avatar_name">Michael R</h2>
                </div>
              </div>
              <div class="slider-for_item">
                <div class="cs-testimonial cs-style1">
                  ...
                  <div class="cs-testimonial_text"> Nabeel 24/7 availability sets them apart. Their prompt responses and proactive communication made our collaboration smooth and efficient. The team's dedication to our success is evident, making them a reliable partner.</div>
                  <div class="cs-rating" data-rating="4">
                    <div class="cs-rating_bg" data-src="assets/img/rating.html"></div>
                    <div class="cs-rating_percentage" data-src="assets/img/rating.html"></div>
                  </div>
                  <h2 class="cs-testimonial_avatar_name">Victor G</h2>
                </div>
              </div>
              <div class="slider-for_item">
                <div class="cs-testimonial cs-style1">
                  ...
                  <div class="cs-testimonial_text">Nabeel comprehensive business plan was a game-changer for our company. It provided clarity and direction for our future endeavors. The team's expertise and commitment to client satisfaction make them our go-to agency for all things business-related. </div>
                  <div class="cs-rating" data-rating="4">
                    <div class="cs-rating_bg" data-src="assets/img/rating.html"></div>
                    <div class="cs-rating_percentage" data-src="assets/img/rating.html"></div>
                  </div>
                  <h2 class="cs-testimonial_avatar_name">Sophic C</h2>
                </div>
              </div>
              <div class="slider-for_item">
                <div class="cs-testimonial cs-style1">
                  ...
                  <div class="cs-testimonial_text">Nabeel exceeded our expectations on all fronts. The development team's creativity, coupled with their strategic social media insights, turned our project into a success story. Their commitment to quality and results is matched. </div>
                  <div class="cs-rating" data-rating="4">
                    <div class="cs-rating_bg" data-src="assets/img/rating.html"></div>
                    <div class="cs-rating_percentage" data-src="assets/img/rating.html"></div>
                  </div>
                  <h2 class="cs-testimonial_avatar_name">Alex R</h2>
                </div>
              </div>
              <div class="slider-for_item">
                <div class="cs-testimonial cs-style1">
                  ...
                  <div class="cs-testimonial_text">Choosing Nabeel was a game-changer for our startup. From the initial consultation to the final delivery, their team demonstrated professionalism and expertise. Their dedication to understanding our brand resulted in a website that truly reflects our identity.</div>
                  <div class="cs-rating" data-rating="4">
                    <div class="cs-rating_bg" data-src="assets/img/rating.html"></div>
                    <div class="cs-rating_percentage" data-src="assets/img/rating.html"></div>
                  </div>
                  <h2 class="cs-testimonial_avatar_name">Eric W</h2>
                </div>
              </div>
            </div>
          </div>
